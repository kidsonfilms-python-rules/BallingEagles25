...
test_df.drop('rest_days', axis=1, inplace=True)
test_df.drop('home_away_NS', axis=1, inplace=True)
test_df.drop('opponent_team', axis=1, inplace=True)
test_df.drop('notD1_incomplete', axis=1, inplace=True)
test_df.drop('tz_dif_H_E', axis=1, inplace=True)
test_df.drop('prev_game_dist', axis=1, inplace=True)
test_df.drop('attendance', axis=1, inplace=True)
test_df.drop('travel_dist', axis=1, inplace=True)
test_df.drop('OT_length_min_tot', axis=1, inplace=True)
train_df.drop('team', axis=1, inplace=True)
train_df.drop('game_date', axis=1, inplace=True)
train_df.drop('game_id', axis=1, inplace=True)
train_df.drop('rest_days', axis=1, inplace=True)
train_df.drop('home_away_NS', axis=1, inplace=True)
train_df.drop('opponent_team', axis=1, inplace=True)
train_df.drop('notD1_incomplete', axis=1, inplace=True)
train_df.drop('tz_dif_H_E', axis=1, inplace=True)
train_df.drop('prev_game_dist', axis=1, inplace=True)
train_df.drop('attendance', axis=1, inplace=True)
train_df.drop('travel_dist', axis=1, inplace=True)
train_df.drop('OT_length_min_tot', axis=1, inplace=True)

output_test_df_norm = pd.DataFrame(scaler.fit_transform(test_df), columns=test_df.columns)
output_train_df_norm = pd.DataFrame(scaler.fit_transform(train_df), columns=train_df.columns)

input_test_df_norm.fillna(0, inplace=True)
input_train_df_norm.fillna(0, inplace=True)
output_test_df_norm.fillna(0, inplace=True)
output_train_df_norm.fillna(0, inplace=True)
...
output_train_df_norm.to_csv('data/processed/train_output_games_2022.csv', index=False)